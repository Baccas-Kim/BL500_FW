/* ========================================================================== */
/*	  Exp04_2a.c : User-Defined Character Display on Text LCD Module      */
/* ========================================================================== */
...
void Set_font(void)                             /* set user character font */
{
  ...
  unsigned char font[] = {
    ...
    0x01, 0x02, 0x04, 0x08, 0x00, 0x00, 0x0F, 0x00,   // character 3 (Ω∫)
    0x10, 0x08, 0x04, 0x02, 0x00, 0x00, 0x1E, 0x00,   // character 4
    0x0F, 0x08, 0x08, 0x0F, 0x08, 0x08, 0x0F, 0x00,   // character 5 (≈Õ)
