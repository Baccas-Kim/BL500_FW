/* ========================================================================== */
/*	Exp19_2.c : DS1307을 이용한 TFT-LCD용 디지털 시계(키 사용)	      */
/* ========================================================================== */
...
int main(void)
{
  ...
  TFT_string(3,35, Cyan,   Black, "KEY1   KEY2   KEY3   KEY4");
  TFT_string(3,37, Magenta,Black, "( )    ( )    ( )    ( ) ");
  TFT_xy( 4,37); TFT_English(0x1B);
  TFT_xy(11,37); TFT_English(0x1A);
  TFT_xy(18,37); TFT_English(0x18);
  TFT_xy(25,37); TFT_English(0x19);
  Rectangle( 13,277,  58,315, Cyan);
  Rectangle( 69,277, 114,315, Cyan);
  Rectangle(125,277, 170,315, Cyan);
  Rectangle(181,277, 226,315, Cyan);
