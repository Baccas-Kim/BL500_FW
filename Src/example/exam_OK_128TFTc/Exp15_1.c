...
int main(void)
{
  ...
  TFT_string(4, 7, White,Magenta," 음악 멜로디 연주(타이머1 이용) ");
  TFT_string(9,12, Cyan,Black,"곡목 : ");
  TFT_string(9,15, Cyan,Black,"작사 : ");
  TFT_string(9,18, Cyan,Black,"작곡 : ");
  TFT_string(9,21, Cyan,Black,"노래 : ");

  while(1)
    { TFT_string(16,12, Red,  Black,"퐁당퐁당       ");	// display music title
      TFT_string(16,15, White,Black,"윤석중");
      TFT_string(16,18, White,Black,"홍난파");
      TFT_string(16,21, Green,Black,"(동요)");
      ...
      TFT_string(16,12, Red,  Black,"낭랑 18세      ");	// display music title
      TFT_string(16,15, White,Black,"유호  ");
      TFT_string(16,18, White,Black,"박시춘");
      TFT_string(16,21, Green,Black,"한서경");
      ...
      TFT_string(16,12, Red,  Black,"돌아가는 삼각지");	// display music title
      TFT_string(16,15, White,Black,"배상태");
      TFT_string(16,18, White,Black,"배상태");
      TFT_string(16,21, Green,Black,"배호  ");
      ...
      TFT_string(16,12, Red,  Black,"칠갑산         ");	// display music title
      TFT_string(16,15, White,Black,"조운파");
      TFT_string(16,18, White,Black,"조운파");
      TFT_string(16,21, Green,Black,"주병선");
      Set_tempo(4);				// set tempo
      ...
      TFT_string(16,12, Red,  Black,"허공           ");	// display music title
      TFT_string(16,15, White,Black,"정욱  ");
      TFT_string(16,18, White,Black,"정풍송");
      TFT_string(16,21, Green,Black,"조용필");
      Set_tempo(4);				// set tempo
