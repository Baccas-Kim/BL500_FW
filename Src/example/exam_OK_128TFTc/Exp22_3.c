...
int main(void)
{
  ...
  while(1)
	...
	while(time_move_flag == 0 && key_move_flag == 0)	
      ...
      TFT_string( 5,16, Green,  Black, "            ");	// wait KEY1 to start
      TFT_string( 5,18, Green,  Black, " Press ");
      TFT_string(12,18, Magenta,Black, "KEY1 ");
      TFT_string( 5,20, Green,  Black, " to start ! ");
      TFT_string( 5,22, Green,  Black, "            ");
